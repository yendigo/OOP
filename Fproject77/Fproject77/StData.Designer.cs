...
namespace Fproject77 {
    ...
    public partial class StData : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string Student_Name, string Course, int Year, string Section) {
...
namespace Fproject77.StDataTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Id], [Student Name], [Course], [Year], [Section]) V" +
                "ALUES (@Id, @Student_Name, @Course, @Year, @Section);\r\nSELECT Id, [Student Numbe" +
                "r], [Student Name], Course, Year, Section FROM Student WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Id] = @Id, [Student Name] = @Student_Name, [Course] = @Course, [Year] = @Year, [Section] = @Section WHERE (([Id] = @Original_Id) AND ([Student Number] = @Original_Student_Number) AND ((@IsNull_Student_Name = 1 AND [Student Name] IS NULL) OR ([Student Name] = @Original_Student_Name)) AND ((@IsNull_Course = 1 AND [Course] IS NULL) OR ([Course] = @Original_Course)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_Section = 1 AND [Section] IS NULL) OR ([Section] = @Original_Section)));
SELECT Id, [Student Number], [Student Name], Course, Year, Section FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Fproject77.Properties.Settings.Default.lastDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [Student Number], [Student Name], Course, Year, Section FROM dbo.Stude" +
                "nt";
        ...
        public virtual int Fill(StData.StudentDataTable dataTable) {
        ...
        public virtual StData.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StData.StudentDataTable dataTable = new StData.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StData.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_Student_Number, string Original_Student_Name, string Original_Course, global::System.Nullable<int> Original_Year, global::System.Nullable<int> Original_Section) {
            ...
            if ((Original_Section.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((int)(Original_Section.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, string Student_Name, string Course, global::System.Nullable<int> Year, global::System.Nullable<int> Section) {
        ...
        public virtual int Update(int Id, string Student_Name, string Course, global::System.Nullable<int> Year, global::System.Nullable<int> Section, int Original_Id, int Original_Student_Number, string Original_Student_Name, string Original_Course, global::System.Nullable<int> Original_Year, global::System.Nullable<int> Original_Section) {
            ...
            if ((Original_Section.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_Section.Value));
            }
            else {
